    ...
    for uci_str in zuege:
        ...
        if board.is_capture(move):
            ...
            if captured_piece:
                ...
                task_queue.put(captured_coords + [False, f"captured_{captured_piece.symbol()}", captured_color])
                task_queue.put(graveyard_coords + [True, f"captured_{captured_piece.symbol()}", captured_color])
        ...
        task_queue.put(from_coords + [False, move_type, mover_color])
        task_queue.put(to_coords + [True, move_type, mover_color])
